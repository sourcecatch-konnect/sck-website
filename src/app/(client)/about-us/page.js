...
export default function Page() {
  ...
  const images = [
    "/about-us/web-dev (1).webp",
    "/about-us/web-dev (2).webp",
    "/about-us/web-dev (3).webp",
    "/about-us/web-dev (4).webp",
    "/about-us/web-dev (5).webp",
    "/about-us/web-dev (6).webp",
  ];
  return (
    <>
      {/* Hero Section */}
          ...
          <div className="w-full md:w-[70%] flex flex-col   py-3 h-full ">
            ...
            <div className="min-h-50 overflow-hidden flex flex-col md:flex-row gap-2 md:gap-9 border-t border-b">
              <div className="w-full md:w-[40%] h-full  relative py-3">
                <div className="absolute hidden md:block left-0 top-0 h-full w-20 bg-gradient-to-r from-[#f9f9f9] z-10 via-[#f9f9f9]/50 to-transparent"></div>
                <div className="absolute hidden md:block right-0 top-0 h-full w-20 bg-gradient-to-l from-[#f9f9f9] z-10 via-[#f9f9f9]/50 to-transparent"></div>
          ...
          <div className="relative max-w-6xl mx-auto w-full h-full py-4 flex ">
            <div className="w-1/2 px-2 md:px-0 flex flex-col gap-2">
              ...
              <div className="text-primary flex gap-2">
                <Link href={"https://wa.me/918263919255"}>
                  <IconBrandWhatsapp />
                </Link>
                <Link
                  href={"https://www.linkedin.com/in/pranav-kothari-b91945169/"}
                >
                  <IconBrandLinkedin />
                </Link>
                {/* <IconBrandInstagram /> */}
