...
const RestOfComp = () => {
  ...
  return (
    <>
      ...
      {/* APNA FOOD SECTION */}
      <div className="max-w-6xl mx-auto w-full my-25 md:mt-50 flex md:flex-row flex-col gap-3">
          ...
          <div className="relative w-full">
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center sm:justify-start gap-6">
                ...
                <div className="h-100 relative overflow-hidden w-50 border-2 rounded-xl md:ml-8">
                  <Image
                    fill
                    alt="TFN Banner"
                    src={"/projects-banner/tfn-banner-2.png"}
                    className="object-cover"
                  />
                </div>
              </div>
