...
export default function page() {
  ...
  const colors = ["#ff6b35", "#ff914d", "#ffa65b"];
  const sampleArcs = [
    {
      order: 1,
      startLat: -19.885592,
  ...
  return (
    <>
      <div className=" w-full flex justify-center items-center py-20 px-5 md:px-0 mt-10">
        <div className="relative h-[400px] max-w-6xl w-full rounded-2xl border bg-black overflow-hidden px-3 md:p-20 flex justify-center items-center">
          <Button
            ...
            className="absolute bg-transparent top-5 left-5 border px-2 py-1 rounded-md text-white z-10"
          >
      ...
      <div
        id="contactForm"
        className=" min-h-100 bg-accent flex gap-3 w-full  py-20  bg-[url(/map.svg)]"
      >
        <div className="max-w-6xl w-full mx-auto flex flex-col md:flex-row">
            ...
            <div className="flex flex-col gap-4">
              <div className="flex flex-col gap-1">
                ...
                <span className=" text-base">
                  First Floor , SK Tower, A-52, Old MIDC, Ayodhya Nagar Road,
                  Jalgaon, 425003
                </span>
              </div>
              <div className="flex flex-col gap-1">
                <span className="font-semibold text-xl">PHONE NUMBER</span>
                <Link href={"tel:+912268563241"} className=" text-base">
                  +91 22-68563241
                </Link>
              </div>
              <div className="flex flex-col gap-1">
                <span className="font-semibold text-xl">EMAIL ADDRESS</span>
                <Link href={"mailto:info@sckonnect.com"} className=" text-base">
                  info@sckonnect.com
                </Link>
              </div>
            </div>
          ...
          <div className="w-full md:w-1/2  h-10 p-4">
            <div className="flex flex-col gap-3">
              ...
              <div className="flex gap-2">
                <Input
                  className={"w-1/2 border-primary/70"}
                  placeholder="Phone"
                  type={"number"}
                />
                <Select className="">
                  <SelectTrigger className="w-1/2 border-primary/70 border">
                    <SelectValue placeholder="Select Service Type" />
                  </SelectTrigger>
                  <SelectContent className={"border-primary/70 border"}>
              ...
              <div className="h-full">
                <Textarea
                  className={"h-20 border-primary/70"}
                  placeholder="Please type you're message here"
                />
              </div>
              <div>
                <Button type="submit">
